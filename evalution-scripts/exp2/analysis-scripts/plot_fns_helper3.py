...
def plot_cdf(k1_data, k2_data, k3_data, k4_data, g_type: str, single="single"):
...
def plot_residue_vs_rounds(k1_data, k2_data, k3_data, k4_data, g_type: str, single="single", res_type="Residue"):
    plt.figure(figsize=(12, 6))
    rounds = min(len(k1_data), len(k2_data), len(k3_data), len(k4_data))
    x = range(rounds)
...
def plot_cum_residue_vs_rounds(k1_data, k2_data, k3_data, k4_data, g_type: str, single="single", res_type="Residue"):
    plt.figure(figsize=(12, 6))
    # print(res_type)
    ...
    k1ind,k1val = find_convergence_index_3(k1_data, epsilon=1/1000, tail_window=20)
    k2ind,k2val = find_convergence_index_3(k2_data, epsilon=1/1000, tail_window=20)
    k3ind,k3val = find_convergence_index_3(k3_data, epsilon=1/1000, tail_window=20)
    k4ind,k4val = find_convergence_index_3(k4_data, epsilon=1/200, tail_window=30)
    # print(k4ind,k4val)
    # treeind,treeval = find_convergence_index_3(tree_data[:rounds], epsilon=1/500,tail_window=20)
    ...
    new_ticks = sorted(current_ticks + [k1ind,k2ind,k3ind,k4ind])
    new_ticks.pop(0)
    print(new_ticks)
