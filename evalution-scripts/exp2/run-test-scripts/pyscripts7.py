...
def run_sim(peer_name: str):
    ...
    arr = random.sample(range(start3, end3), 50)
    print(f"Re-adding {60} random members in the group: {group_name}")
...
if __name__ == "__main__":
    ...
    args = sys.argv
    if len(args) == 1:
        print("Please pass first argument as the group name.")
        exit(1)
    ...
    ops_log_file=f"{peer_name}_{group_name}_ops.log"
    # print(ops_log_file)
